/**
 * Handstand API Integration Tests
 * 
...
// Use the actual database - tests will clean up after themselves
const pool = new Pool({
...
describe('Handstand API Integration Tests', () => {
  let testEmail;
  ...
  describe('Progress Logging', () => {
    it('should log progress for an exercise', async () => {
      ...
      const res = await request(API_URL)
        ...
        .send({
          level: 1,
          exercise_key: 'wrist_heel_raises',
          sets_completed: 3,
      ...
      expect(res.body.log.exercise_key).toBe('wrist_heel_raises');
    });
